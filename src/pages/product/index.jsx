...
import { Tabs, ProductsCarousel, SectionHeading, MainIconBtn, SmallBtn, FlowerLoader, Sp, Mrp } from "../../components";
...
export function ProductDetail() {
    ...
    return (
        <>
            <section className="product-detail-con">
                    ...
                    <div className="col">
                        ...
                        <div>
                            ...
                            <div className="product-btn-con">
                                ...
                                <MainIconBtn
                                    info={{ name: "Add to cart", img: cart, handleAddToCart: () => handleAddToCart(productDetail) }}
                                />
                            </div>
                        </div>
                    </div>
